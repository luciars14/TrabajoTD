...
crea.tablaX = function(vector_matrizporfilas,numalternativas=3,numestados=4) {
...
# Estas funciones nos indican dónde se alcanzan los mínimos y los máximos y al 
# estar puesta en general, nos devuelve varios valores en los que hay empate.
...
# En la función de debajo, que es el criterio de Hurwicz, hay que añadir adicionalmente un alpha
...
# Función para representar mediante dibujo el criterio de Hurwicz:
